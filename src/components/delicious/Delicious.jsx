...
import videoPoster from './../../images/delecious/cooking.png';
import video from './../../videos/cooking1.mp4';
...
const Delicious = () => {
    ...
    const handlePlay = () => {
        if (videoRef.current) {
            ...
            videoRef.current.controls = true; // Для появи стандартних кнопок управління плеєром
            setIsStarted(true); // Приховую кастомну кнопку
        }
    }
			...
			<div className="container">
				<div className="cooking__row">
					<div className="cooking__img">
						...
						<div className="badge">we have</div>
					...
					<div className="cooking__text">
						...
						<div className="cooking__video">
							<video ref={videoRef} src={video} poster={videoPoster} width="100%"/>

							{/* Умовний рендеринг: кнопка зникне, коли відео запуститься */}
							{!isStarted && (
								<button className='btn btn-active' onClick={handlePlay}>
									<svg width="20" height="23" viewBox="0 0 20 23" fill="none">
										<path d="M17.3594 10.6055C17.6839 10.7995 17.6839 11.2688 17.3594 11.4629L2.25683 20.4941C1.92359 20.6934 1.50008 20.4537 1.5 20.0654L1.5 2.00293C1.50008 1.61468 1.92359 1.37495 2.25684 1.57422L17.3594 10.6055Z" stroke="white" strokeWidth="3" />
									</svg>
									Cooking Process
								</button>
							)}
